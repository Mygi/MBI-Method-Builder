...
public class DerivationDataSetImportForm extends ValidatedInterfaceComponent implements
AsynchronousAction {
...
public DerivationDataSetImportForm(List<LocalFile> files, DObjectRef o,
	DerivationDataSetCreateFCP fcp) {
_o = o;
_fcp = fcp;
_fcp.setPid(o.id());
