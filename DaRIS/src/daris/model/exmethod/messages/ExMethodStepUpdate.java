...
public class ExMethodStepUpdate extends ObjectMessage<Boolean> {
	...
	public ExMethodStepUpdate(String exMethodId, String stepPath, String state, String notes) {
	...
	public ExMethodStepUpdate(ExMethodStep step) {
		this(step.exMethodId(), step.stepPath(), step.state().toString(), step.notes());
	}
